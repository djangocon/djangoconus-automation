    ...
    class Meta:
        ...
        widgets = {
            ...
            'arrival_airline': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., United Airlines, Delta'
            }),
            'arrival_flight_number': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., UA1234, DL567'
            }),
            ...
            'arrival_airport': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., ORD, MDW, RFD'
            }),
            'departure_airline': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., United Airlines, Delta (optional)'
            }),
            'departure_flight_number': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., UA1234, DL567 (optional)'
            }),
            ...
            'departure_airport': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., ORD, MDW, RFD (optional)'
            }),
            'departure_destination': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Where are you flying to? (optional)'
            }),
